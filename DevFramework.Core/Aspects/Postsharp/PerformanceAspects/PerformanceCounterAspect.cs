...
{
    [Serializable]
    class PerformanceCounterAspect : OnMethodBoundaryAspect
    {
        private int _interval; //Bir metodun başlangıcından bitişine geçen süre
        ...
        //Stopwatchın örneğini oluşturmamız gerekiyor, bir örnek oluşturulması gerektiğinde bunu reflection ile yapıyoruz
